<?php
if(!$user)	{
	$_SESSION['msg'] = "Авторизируйтесь, чтобы просмотреть свои объявления";
	...
	$page = $_GET['page'];
	$num = 5;
	$result00 = mysql_query("SELECT COUNT(*) FROM ".PREF."post 
	...
	$my_posts = get_my_posts($user_id,$id_categories,$id_categories,$sort,$id_section,$id_town,$start,$num,$search);
